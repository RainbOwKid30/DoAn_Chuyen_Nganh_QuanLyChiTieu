...
class _LineChartSample2State extends State<HomeLineChart> {
  ...
  Widget bottomTitleWidgets(double value, TitleMeta meta) {
    ...
    if (value == 0) {
      text = const Text('1', style: style); // 1/11
    } else if (value == 11) {
      text = const Text('31', style: style); // 31/11
    } else {
      text =
  ...
  LineChartData mainData() {
    return LineChartData(
      ...
      minX: 0,
      maxX: 11, // Giá trị maxX để biểu đồ có thể hiển thị tới ngày 11
      minY: 0,
      maxY: 6,
      lineBarsData: [
        LineChartBarData(
